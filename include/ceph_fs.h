...
/*fengyu@datatom.com add for quota begin*/
#define BYTES_QUOTA_FLAG_INVALID -1
#define BYTES_QUOTA_FLAG_NOT_EXCEED 0
#define BYTES_QUOTA_FLAG_EXCEED 1
/*fengyu add for quota end*/
...
enum {
	...
	/*fengyu@datatom.com add for quota begin*/
	CEPH_MDS_OP_CHECK_QUOTA_4_INFINITY = 0x00199,
	/*fengyu add for quota end*/
