...
OPTION(client_quota, OPT_BOOL) // use quota for df on subdir mounts
// added end
...
OPTION(osd_qos_r_lat_base_hdd, OPT_FLOAT)
OPTION(osd_qos_r_lat_base_ssd, OPT_FLOAT)
OPTION(osd_qos_r_lat_coefficient_hdd, OPT_FLOAT)
OPTION(osd_qos_r_lat_coefficient_ssd, OPT_FLOAT)
OPTION(osd_qos_w_lat_base_hdd, OPT_FLOAT)
OPTION(osd_qos_w_lat_base_ssd, OPT_FLOAT)
OPTION(osd_qos_w_lat_coefficient_hdd, OPT_FLOAT)
OPTION(osd_qos_w_lat_coefficient_ssd, OPT_FLOAT)
OPTION(osd_debug_record_recent_ops_latency, OPT_BOOL)
OPTION(osd_debug_recent_ops_size, OPT_U32)    // Max number of completed ops to record
OPTION(osd_debug_recent_ops_duration, OPT_U32) // Oldest completed op to record
...
// added by zhang.peng1989@datatom.com, unlink debug output
OPTION(infinity_mds_audit_delete, OPT_BOOL)
// added end

// added by lei.xianqiang@datatom.com
OPTION(infinity_rgw_default_read_user, OPT_STR)
// added end
