...
std::vector<Option> get_global_options() {
  return std::vector<Option>({
    ...
    // added start by lei.xianqiang@datatom.com
    Option("mon_osd_down_out_subtree_limit_interval", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(1800)
    .add_service("mon")
    .set_description("mark OSDs 'out' if an entire subtree of this size is down for this long (seconds)")
    .add_see_also("mon_osd_down_out_subtree_limit"),
    // added end by lei.xianqiang@datatom.com
    ...
    // OSD QoS, added start by lei.xianqiang@datatom.com
    Option("osd_qos_r_lat_base_hdd", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(5)
    .set_description("The base that calculate read latency(ms) for HDDs")
    .add_see_also("osd_qos_r_lat_coefficient_hdd"),

    Option("osd_qos_r_lat_base_ssd", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(0.1)
    .set_description("The base that calculate read latency(ms) for SSDs")
    .add_see_also("osd_qos_r_lat_coefficient_ssd"),

    Option("osd_qos_r_lat_coefficient_hdd", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(0.02)
    .set_description("The coefficient that calculate read latency(ms) for HDDs")
    .add_see_also("osd_qos_r_lat_base_hdd"),

    Option("osd_qos_r_lat_coefficient_ssd", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(0.002)
    .set_description("The coefficient that calculate read latency(ms) for SSDs")
    .add_see_also("osd_qos_r_lat_base_ssd"),

    Option("osd_qos_w_lat_base_hdd", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(5)
    .set_description("The base that calculate write latency(ms) for HDDs")
    .add_see_also("osd_qos_w_lat_coefficient_hdd"),

    Option("osd_qos_w_lat_base_ssd", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(0.1)
    .set_description("The base that calculate write latency(ms) for SSDs")
    .add_see_also("osd_qos_w_lat_coefficient_ssd"),

    Option("osd_qos_w_lat_coefficient_hdd", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(0.02)
    .set_description("The coefficient that calculate write latency(ms) for HDDs")
    .add_see_also("osd_qos_w_lat_base_hdd"),

    Option("osd_qos_w_lat_coefficient_ssd", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(0.002)
    .set_description("The coefficient that calculate write latency(ms) for SSDs")
    .add_see_also("osd_qos_w_lat_base_ssd"),

    Option("osd_debug_record_recent_ops_latency", Option::TYPE_BOOL, Option::LEVEL_DEV)
    .set_default(false)
    .set_description(""),

    Option("osd_debug_recent_ops_size", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(256)
    .set_description("")
    .add_see_also("osd_debug_record_recent_ops_latency"),

    Option("osd_debug_recent_ops_duration", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(30)
    .set_description("")
    .add_see_also("osd_debug_record_recent_ops_latency"),
    // OSD QoS, added end by lei.xianqiang@datatom.com
  ...
  .set_min_max((int64_t)PerfCountersBuilder::PRIO_DEBUGONLY,
    ...
    // added start by lei.xianqiang@datatom.com
    Option("mon_data_balance_enabled", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .add_service("mon")
    .set_description("enable data balance when osdmap changed"),

     Option("mon_max_pg_upmaps_ratio", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(0.1)
    .set_flag(Option::FLAG_RUNTIME)
    .set_description("Max ratio of pg upmap items"),

    Option("mon_data_balance_upmap_deviation", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(2)
    .add_service("mon")
    .set_description("max deviation from target for data balance")
    .add_see_also("mon_data_balance_enabled"),

    Option("mon_data_balance_calc_upmap_timeout", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(100.0)
    .add_service("mon")
    .set_description("async calc pg upmaps timeout (seconds)")
    .add_see_also("mon_data_balance_enabled"),

    Option("mon_inject_calc_upmaps_delay", Option::TYPE_FLOAT, Option::LEVEL_DEV)
    .set_default(0)
    .add_service("mon")
    .set_description("inject delay during calc pg upmaps (seconds)")
    .add_see_also("mon_data_balance_enabled"),

    Option("mon_async_data_balance_tick_interval", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(60)
    .add_service("mon")
    .set_description("interval for internal mon background async data balance")
    .add_see_also("mon_data_balance_enabled"),
    // added end by lei.xianqiang@datatom.com
...
std::vector<Option> get_rgw_options() {
  return std::vector<Option>({
    ...
    Option("infinity_rgw_default_read_user", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("")
    .set_description("Anonymous user read requests use this ID to reduce latency")
    .set_long_description("Anonymous user read requests use this ID to reduce latency, "
        "only objects that have public-read permissions can be read"),
    // added end
...
std::vector<Option> get_mds_options() {
  return std::vector<Option>({
	...
	// added by liu.yong@datatom.com, init infinity mds delete config
	 Option("infinity_mds_audit_delete", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description(""),
    // added end
  });
...
std::vector<Option> get_mds_client_options() {
  return std::vector<Option>({
    ...
    // added by Denis Liu (liu.yong@datatom.com)
